    ...
    if st.button("Calibra modello"):
        try:
            if calibration_method in ["Isotonic", "Sigmoid"]:
                calibrated_model = CalibratedClassifierCV(best_model, method=calibration_method.lower(), cv=3)
            ...
            # Calcolo ECE se ci sono probabilità
